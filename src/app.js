...
export class App {
  configureRouter(config, router) {
    ...
    config.map([
      ...
      {"route": "inmates/data/:id", "name": "inmates-data-form", "moduleId": PLATFORM.moduleName("../inmates/data-form"), "nav": true, "title": "Data Form",href: 'inmate/123', },
     
     
      // { "route": 'inmates/data/:id', name: 'inmates-data-form', moduleId: '../inmates/data-form', title: 'Data Form' },
